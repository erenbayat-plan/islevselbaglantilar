            ...
            <div className="custom-modal-body">
              ...
              <div className="form-field-group">
                ...
                <input
                  ...
                  placeholder="Örn: Ulaşım Ağı Maruziyet ve Risk Analizi"
                  value={name}
                  onChange={e => {
              ...
              <div className="form-grid-2">
                <div className="form-field-group">
                  ...
                  <datalist id="category-suggestions">
                    ...
                    <option value="Tehlike & Maruziyet Analizi" />
                    <option value="Kapanma & İşlev Kaybı Analizi" />
                    <option value="Erişilebilirlik & Tahliye Analizi" />
                    <option value="Kritik Altyapı & Odak Analizi" />
                    <option value="İklim & Taşkın Modellemesi" />
                  </datalist>
                </div>
