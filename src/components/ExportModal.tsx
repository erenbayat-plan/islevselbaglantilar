...
export const ExportModal: React.FC<ExportModalProps> = ({
  ...
  const generateCSV = () => {
    ...
    chapters.forEach(ch => {
      ...
      allItems.forEach(item => {
        ...
        rows.push([
          ...
          `"%${st.progress ?? (st.status === 'completed' ? 100 : st.status === 'review' ? 75 : st.status === 'drafting' ? 50 : 0)}"`,
          `"${(st.author || '').replace(/"/g, '""')}"`,
    ...
    link.setAttribute('download', `Plan_2050_${groupName}_Rapor_Matrisi_${new Date().toISOString().slice(0, 10)}.csv`);
  ...
  const handleCopySummary = () => {
    ...
    chapters.forEach(ch => {
      ...
      allItems.forEach(item => {
        ...
        summaryText += `  • ${item.code} ${item.title} -> [${getStatusLabel(st.status)}] (%${st.progress || 0})${authorStr}${pagesStr}\n`;
      });
    });
      ...
      <div className="modal-dialog" onClick={e => e.stopPropagation()}>
        <div className="modal-header">
          <div className="modal-title-wrap">
            <h3>Dışa Aktar, Yazdır & Rapor Yönetimi</h3>
            <p>{groupName} Rapor Çatkısı ve Analiz Matrisini Paylaşın</p>
          </div>
        ...
        <div className="modal-body">
          <div className="export-options-grid">
            ...
            <div className="export-option-card">
              <div className="eoc-content">
                <h4>Excel / CSV Matrisi İndir</h4>
                <p>1., 2., 3. ve 4. düzey başlıklar, analiz listeleri, yazar atamaları, hedef sayfa sayıları ve koordinasyon notlarını Excel uyumlu CSV olarak indirin.</p>
            ...
            <div className="export-option-card">
              <div className="eoc-content">
                <h4>Yazdır / PDF Olarak Kaydet</h4>
                <p>Yönetim sunumları ve koordinasyon toplantıları için temiz sayfa düzeninde yazdırın veya PDF olarak kaydedin.</p>
            ...
            <div className="export-option-card">
              <div className="eoc-content">
                <h4>Metin Durum Özeti Kopyala</h4>
          ...
          <div className="modal-danger-zone">
            <div className="mdz-text">
              <h5>Çatkı Verilerini Sıfırla</h5>
