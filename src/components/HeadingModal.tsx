...
import { X, AlertCircle, BookmarkPlus, Edit3 } from 'lucide-react';
    ...
    if (isOpen) {
      if (initialData) {
        setFormData({
          ...
          defaultPages: initialData.defaultPages || '6-10 sf',
              ...
              <div className="form-grid-2">
                ...
                <div className="form-field-group">
                  ...
                  <input
                    ...
                    placeholder="Örn: 6-10 sf veya 12 sf"
